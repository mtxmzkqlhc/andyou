...
class Snoopy
{
	...
	var $agent			=	"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/31.0.1622.0 Safari/537.36";	// agent we masquerade as
...
\*======================================================================*/
	...
	function submit($URI, $formvars="", $formfiles="",$posttxt = false)
	{
		unset($postdata);
