<?php
/**
* 阿里云存储OSS(Open Storage Services)的接口
 *
* @author zhongwt
...
define('ALI_LOG_PATH','');//自定义日志路径，如果没有设置，则使用系统默认路径，在./logs/
...
class API_Item_Open_AliOss
{
    ...
    private static function init() {
        ...
        if(!self::$conObj){
            ...
            $ossSdkService->set_debug_mode(FALSE);      //设置是否打开curl调试模式
