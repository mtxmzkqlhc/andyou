 ...
 * 会员相关
 */
class Helper_Yun_Member extends Helper_Abstract {
    ...
    public static function checkPasswd($paramArr) {
		...
		extract($options);
         ...
         $password = Helper_Yun_AdminUser::passwdEncrypt($password);
         $userInfo = Helper_Yun_AdminUser::getAdminUserInfo(array('userId'=>$userId));
         $rtnFlag = 0;
         if($userInfo){
