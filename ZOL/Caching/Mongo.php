...
//    protected static $server   = 'mongodb://localhost:27017';
    ...
    protected static $timeout = 30000;//30s
    ...
    protected  static function getMod($modName,$mongoDBKey='',$dbName='Product')
    {
...
//        }
    ...
    public static function set($modName, $key = '', $var = '', $expire = 0,$mongoDBKey=0,$isMongoWrite=0,$dbName='Product')
    {
        self::init($mongoDBKey,$isMongoWrite);   
