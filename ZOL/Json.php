...
class ZOL_Json
{
     ...
     * objects. See {@link ZOL_Json_Decoder::decode()} for details.
     * @return mixed
     */
    public static function decode($encodedValue, $objectDecodeType = ZOL_Json::TYPE_ARRAY)
    {
        if (function_exists('json_decode') && self::$useBuiltinEncoderDecoder !== true) {
            return json_decode($encodedValue, $objectDecodeType);
        }

        return ZOL_Json_Decoder::decode($encodedValue, $objectDecodeType);
    }
    ...
    public static function encode($valueToEncode, $cycleCheck = false, $options = array())
    {
        ...
        return ZOL_Json_Encoder::encode($valueToEncode, $cycleCheck, $options);
    }
     ...
     *
     * Throws a ZOL_Exception if the input not a XML formatted string.
     *
     * @static
     * @access public
    ...
    public static function fromXml ($xmlStringContents, $ignoreXmlAttributes=true) {
        ...
        if ($simpleXmlElementObject == null) {
            throw new ZOL_Exception('Function fromXml was called with an invalid XML formatted string.');
        ...
        // Convert the PHP array to JSON using ZOL_Json encode method.
     ...
     *
     * Throws a ZOL_Exception if the XML tree is deeper than the allowed limit.
     *
     * @static
     * @access protected
