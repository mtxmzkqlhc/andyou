...
UE.I18N['zh-cn'] = {
    'labelMap':{
        ...
        'lineheight':'行间距','edittip' :'编辑提示','customstyle':'字体', 'autotypeset':'自动排版', 'webapp':'百度应用',
    ...
    'edittable':{
        'static':{
            ...
            'lang_autoSizeDefault':'默认',
            'lang_autoSizeContent':'文字自适应',
            'lang_autoSizePage':'宽度自适应',
            'lang_example':'示例',
