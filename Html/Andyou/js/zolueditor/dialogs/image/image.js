...
(function () {
    ...
    function insertSingle() {
        ...
        imgObj.alt = alt.value;
        imgObj.style = "width:" + width.value + "px;height:" + height.value + "px;display:inline;";
        insertImage(imgObj);
    ...
    function showPreviewImage(img, needClone) {
        ...
        preview.innerHTML = '<img src="' + target.src + '" width="' + target.width + '" border="' + target.border + 'px solid #000" />';
    }
