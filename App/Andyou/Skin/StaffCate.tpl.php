...
<div class="row-fluid">
    <div id="content" class="span12">         
        <h3 class="page-title">员工分类管理</h3>
        <div class="row-fluid sortable">		
            <div class="box span12">
                <div class="box-header" data-original-title>
                	  <h2><i class="halflings-icon align-justify"></i><span class="break"></span>员工分类管理</h2>
...
<input type="hidden" value="StaffCate" name="c">
...
<button type="submit" class="btn-ser">查看</button></form></div>
                    ...
                    <table class="table table-center table-striped table-bordered bootstrap-datatable ">
                     <thead>
<tr>
<th>ID</th><th>名称</th><th>底薪</th><th>提成比例</th><th>操作</th>
</tr>
</thead>
<tbody>
<?php
if($data) {
   foreach($data as $v) {
       ...
       $outStr.='<td rel="'.$v['id'].'">
       <a title="修改" class="btn btn-info editbtnStaffCate"><i class="halflings-icon white edit"></i></a>
                ...
                <form id="addform" method="post" action="?">
                    <table>
                        <tbody><tr><td> <table class="item_edit_table"> <tbody>
                         ...
                         <input type="hidden" name="c" value="StaffCate">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editform" method="post" action="?">
                    <table>
                        <tbody><tr><td> <table class="item_edit_table"><tbody>
                          <tr><td align="right">名称:</td><td><input type="text" id="name"  name="name" /></td></tr>
...
$('.editbtnStaffCate').live('click',function(){
    var id = $(this).parent().attr('rel');
    getdatainfo(id,'StaffCate',function(dat){
        $('#name').val(dat['name']);
...
var setDataValue = function(id,col,val){
   ...
   $.ajax({
        type: "POST",
        url: "/?c=StaffCate&a=SetValue",
        data: postArr,
        success:function(){
           document.location=bkUrl?bkUrl:'?c=StaffCate';
        }
   });
}
