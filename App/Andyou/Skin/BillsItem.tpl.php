...
订单ID：<input style="width:100px;"  type="text" value="<?=$serbid?>" name="bid" >
单号：<input style="width:100px;"  type="text" value="<?=$serbno?>" name="bno" >
产品ID：<input style="width:100px;"  type="text" value="<?=$serproId?>" name="proId" placeholder="产品ID">
员工：<input style="width:100px;"  type="text" value="<?=$serstaffid?>" name="staffid" placeholder="员工">
会员：<input style="width:100px;"   type="text" value="<?=$sermemberId?>" name="memberId" placeholder="会员">
