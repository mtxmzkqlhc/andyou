        ...
        <div class="row-fluid sortable">		
            <div class="box span12">
                <div class="box-header" data-original-title>
                	  <h2><i class="halflings-icon align-justify"></i><span class="break"></span>充值记录</h2>
                </div>
                ...
                <form id="addform" method="post" action="?">
                    <table>
                        <tbody><tr><td> <table class="item_edit_table"> <tbody>						
                          ...
                          <tr><td align="right">变化余额:</td><td><input type="text"   name="card" /></td></tr>
                          <tr><td align="right">原余额:</td><td><input type="text"   name="orgCard" /></td></tr>

                         </tbody></table></td></tr></tbody></table>
                         <input type="hidden" name="a" value="AddItem">
                         <input type="hidden" name="c" value="LogCardChange">
                ...
                <form id="editform" method="post" action="?">
                    <table>
                        <tbody><tr><td> <table class="item_edit_table"><tbody>
                          ...
                          <tr><td align="right">变化余额:</td><td><input type="text" id="card"  name="card" /></td></tr>
                          <tr><td align="right">原余额:</td><td><input type="text" id="orgCard"  name="orgCard" /></td></tr>
...
$('.editbtnLogCardChange').live('click',function(){
    var id = $(this).parent().attr('rel');
    getdatainfo(id,'LogCardChange',function(dat){
        $('#memberId').val(dat['memberId']);
        $('#direction').val(dat['direction']);
        $('#card').val(dat['card']);
        $('#orgCard').val(dat['orgCard']);
...
var setDataValue = function(id,col,val){
   ...
   $.ajax({
        type: "POST",
        url: "/?c=LogCardChange&a=SetValue",
        data: postArr,
        success:function(){
           document.location=bkUrl?bkUrl:'?c=LogCardChange';
        }
   });
}
