 ...
 *
 */
class  Andyou_Page_LogCardChange  extends Andyou_Page_Abstract {
    /**
     * 验证
     */
    public function validate(ZOL_Request $input, ZOL_Response $output){
		$output->pageType = 'LogCardChange';
	...
	public function doDefault(ZOL_Request $input, ZOL_Response $output){
		...
		$output->setTemplate('LogCardChange');
	}
	...
	public function doAddItem(ZOL_Request $input, ZOL_Response $output){
        ...
        $Arr['card'] = $input->post('card');
        $Arr['orgCard'] = $input->post('orgCard');
     ...
     */
	 public function doUpItem(ZOL_Request $input, ZOL_Response $output){
        ...
        $input->request('card')?$Arr['card'] = $input->request('card'):'';
        $input->request('orgCard')?$Arr['orgCard'] = $input->request('orgCard'):'';
